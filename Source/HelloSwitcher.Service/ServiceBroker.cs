...
public static class ServiceBroker
{
	...
	public static void Install(string arguments = null)
	{
		...
		try
		{
			ManagedInstallerClass.InstallHelper(["/LogFile=", $"{ProjectInstaller.ArgumentsOption}{arguments}", ServiceFilePath]);
		}
	...
	public static void Uninstall()
	{
		...
		try
		{
			ManagedInstallerClass.InstallHelper(["/LogFile=", "/u", ServiceFilePath]);
		}
		catch (InvalidOperationException)
		{
		}
